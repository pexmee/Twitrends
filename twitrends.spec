...
cp /github/workspace/README.md $RPM_BUILD_ROOT/usr/local/bin/Twitrends
cp -r /github/workspace/license $RPM_BUILD_ROOT/usr/local/bin/Twitrends
cp /github/workspace/twitrends/trend_modules/__init__.py $RPM_BUILD_ROOT/usr/local/bin/Twitrends/twitrends/trend_modules
cp /github/workspace/twitrends/trend_modules/trend_bot.py  $RPM_BUILD_ROOT/usr/local/bin/Twitrends/twitrends/trend_modules
cp /github/workspace/twitrends/trend_modules/settings.py  $RPM_BUILD_ROOT/usr/local/bin/Twitrends/twitrends/trend_modules
cp /github/workspace/twitrends/trends_settings.json  $RPM_BUILD_ROOT/usr/local/bin/Twitrends/twitrends
cp /github/workspace/twitrends/twitrends.py  $RPM_BUILD_ROOT/usr/local/bin/Twitrends/twitrends
cp /github/workspace/twitrends/twitter_ids.txt  $RPM_BUILD_ROOT/usr/local/bin/Twitrends/twitrends
